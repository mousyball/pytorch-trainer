"""
File is copied from https://github.com/lessw2020/Ranger21
...
@OPTIMIZERS.register(name='Ranger21')
class Ranger21(TO.Optimizer):
    def __init__(
        ...
        if self.warmdown_active:
            ...
            # used to verify warmup reaches full set point.
            ...
            for p in group["params"]:
                ...
                if self.use_madgrad:
                    ...
                    if not self.use_adabelief:
                        grad_ma.mul_(beta1 ** 2).add_(grad,
                                                      alpha=1 - beta1 ** 2)
